...
__C.GAN.R_NUM = 2
__C.GAN.P_NUM = 15 # number of semantic segmentation parts
__C.GAN.B_ATTENTION = True
__C.GAN.Z_MLP_NUM = 4
__C.GAN.PUZZLE_NUM = [4]
__C.GAN.MAX_LENGTH_CLS = 5

__C.TEXT = edict()
__C.TEXT.CAPTIONS_PER_IMAGE = 10
__C.TEXT.EMBEDDING_DIM = 256
__C.TEXT.WORDS_NUM = 18
__C.TEXT.GLOVE_EMBEDDING_DIM = 100
